 ...
 *
 * Usage:
 *   npx tsx audit-agents.ts [repo-root]
 *
 * Exit codes:
...
const PATH_PATTERN = /\b(src|lib|app|packages|cmd|internal|pkg|api)\/[A-Za-z0-9_\-./]+\.[A-Za-z]{1,5}\b/

const SAFETY_KEYWORDS = /\b(secret|password|credential|api key|token|auth|security|vulnerab|injection|xss|csrf)\b/i
